...
const fetchClassroom = require('../constants/API_URL').fetchClassroom
const cookieDao = require('../db/CookieDao').CookieDao
const write = require('../cache').write

async function CrawlerEmptyclassroom(query, userId, cookie) {
...
exports.ClassroomDao = CrawlerEmptyclassroom
