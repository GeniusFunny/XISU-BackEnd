...
const fetchLoginInfo = require('../constants/API_URL').fetchLoginInfo
const login = require('../constants/API_URL').login
const sleep = require('../util/sleep').sleep
const recordLogin = require('../db/user').login

async function CrawlerLogin(username, password) {
  let cookie = ''
