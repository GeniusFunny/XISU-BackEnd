...
const fetchCourseTable = require('./API_URL').fetchCourseTable
const fetchCourseTask = require('./API_URL').fetchCourseTask
const fetchCourseTableId = require('./API_URL').fetchCourseTableId
...
async function CourseTableDao(userId) {
...
exports.CourseTableDao = CourseTableDao
